...
function handlePlay() {
    if (music.paused) {
        ...
        playBtn.innerHTML = '<i class="material-icons"><i class="fa fa-pause" aria-hidden="true"></i></i>'
    } else {
        music.pause();
        playBtn.className = 'play'
        playBtn.innerHTML = '<i class="material-icons"><i class="fa fa-play" aria-hidden="true"></i>'
    }
